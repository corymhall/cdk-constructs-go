...
func (j *jsiiProxy_DashboardWithBitmapCopy) DashboardArn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dashboardArn",
...
func (j *jsiiProxy_DashboardWithBitmapCopy) DashboardName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"dashboardName",
...
func NewDashboardWithBitmapCopy(scope constructs.Construct, id *string, props *awscloudwatch.DashboardProps) DashboardWithBitmapCopy {
	...
	if err := validateNewDashboardWithBitmapCopyParameters(scope, id, props); err != nil {
		panic(err)
	}
...
func DashboardWithBitmapCopy_IsConstruct(x interface{}) *bool {
	...
	if err := validateDashboardWithBitmapCopy_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func DashboardWithBitmapCopy_IsOwnedResource(construct constructs.IConstruct) *bool {
	...
	if err := validateDashboardWithBitmapCopy_IsOwnedResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func DashboardWithBitmapCopy_IsResource(construct constructs.IConstruct) *bool {
	...
	if err := validateDashboardWithBitmapCopy_IsResourceParameters(construct); err != nil {
		panic(err)
	}
	var returns *bool
...
func (d *jsiiProxy_DashboardWithBitmapCopy) AddVariable(variable awscloudwatch.IVariable) {
