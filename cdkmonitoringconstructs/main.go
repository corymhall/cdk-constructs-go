...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "determineAction", GoMethod: "DetermineAction"},
	...
	_jsii_.RegisterClass(
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.jsiiProxy_IAlarmNamingStrategy)
			return &j
		},
	)
	_jsii_.RegisterClass(
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "widgetsForDashboard", GoMethod: "WidgetsForDashboard"},
		},
		func() interface{} {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "invertStatisticsOfTaskCountEnabled", GoGetter: "InvertStatisticsOfTaskCountEnabled"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*AuroraAlarmFactory)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMaxServerlessDatabaseCapacity", GoMethod: "AddMaxServerlessDatabaseCapacity"},
			_jsii_.MemberProperty{JsiiProperty: "alarmFactory", GoGetter: "AlarmFactory"},
		},
		func() interface{} {
			return &jsiiProxy_AuroraAlarmFactory{}
		},
	)
	_jsii_.RegisterClass(
		"cdk-monitoring-constructs.AuroraClusterMonitoring",
		reflect.TypeOf((*AuroraClusterMonitoring)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addAlarm", GoMethod: "AddAlarm"},
			_jsii_.MemberProperty{JsiiProperty: "alarms", GoGetter: "Alarms"},
			_jsii_.MemberMethod{JsiiMethod: "alarmWidgets", GoMethod: "AlarmWidgets"},
			_jsii_.MemberProperty{JsiiProperty: "commitLatencyMetric", GoGetter: "CommitLatencyMetric"},
			_jsii_.MemberProperty{JsiiProperty: "connectionAlarmFactory", GoGetter: "ConnectionAlarmFactory"},
			_jsii_.MemberProperty{JsiiProperty: "connectionAnnotations", GoGetter: "ConnectionAnnotations"},
			...
			_jsii_.MemberMethod{JsiiMethod: "createLatencyWidget", GoMethod: "CreateLatencyWidget"},
			_jsii_.MemberMethod{JsiiMethod: "createMetricFactory", GoMethod: "CreateMetricFactory"},
			_jsii_.MemberMethod{JsiiMethod: "createServerlessDatabaseCapacityWidget", GoMethod: "CreateServerlessDatabaseCapacityWidget"},
			_jsii_.MemberMethod{JsiiMethod: "createTitleWidget", GoMethod: "CreateTitleWidget"},
			_jsii_.MemberMethod{JsiiMethod: "createWidgetFactory", GoMethod: "CreateWidgetFactory"},
			...
			_jsii_.MemberProperty{JsiiProperty: "serverlessCapacityAnnotations", GoGetter: "ServerlessCapacityAnnotations"},
			_jsii_.MemberProperty{JsiiProperty: "serverlessDatabaseCapacityMetric", GoGetter: "ServerlessDatabaseCapacityMetric"},
			_jsii_.MemberMethod{JsiiMethod: "summaryWidgets", GoMethod: "SummaryWidgets"},
			_jsii_.MemberProperty{JsiiProperty: "title", GoGetter: "Title"},
	...
	_jsii_.RegisterStruct(
		"cdk-monitoring-constructs.AuroraClusterMonitoringOptions",
		reflect.TypeOf((*AuroraClusterMonitoringOptions)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"cdk-monitoring-constructs.AuroraClusterMonitoringProps",
		reflect.TypeOf((*AuroraClusterMonitoringProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
	...
	_jsii_.RegisterStruct(
		"cdk-monitoring-constructs.BaseLoadBalancerMetricFactoryProps",
		reflect.TypeOf((*BaseLoadBalancerMetricFactoryProps)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterStruct(
		"cdk-monitoring-constructs.ChangeInSecretCountThreshold",
		reflect.TypeOf((*ChangeInSecretCountThreshold)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "createWidgetFactory", GoMethod: "CreateWidgetFactory"},
			_jsii_.MemberProperty{JsiiProperty: "distributionUrl", GoGetter: "DistributionUrl"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CloudWatchLogsMetricFactory)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "metricIncomingLogEvents", GoMethod: "MetricIncomingLogEvents"},
		},
		func() interface{} {
			return &jsiiProxy_CloudWatchLogsMetricFactory{}
		},
	)
	_jsii_.RegisterStruct(
		"cdk-monitoring-constructs.CloudWatchLogsMetricFactoryProps",
		reflect.TypeOf((*CloudWatchLogsMetricFactoryProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*CompositeMetricAdjuster)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "adjustMetric", GoMethod: "AdjustMetric"},
		},
		func() interface{} {
			j := jsiiProxy_CompositeMetricAdjuster{}
			_jsii_.InitJsiiProxy(&j.jsiiProxy_IMetricAdjuster)
			return &j
		},
	)
	_jsii_.RegisterClass(
		"cdk-monitoring-constructs.ConnectionAlarmFactory",
		reflect.TypeOf((*ConnectionAlarmFactory)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addMaxConnectionCountAlarm", GoMethod: "AddMaxConnectionCountAlarm"},
			_jsii_.MemberMethod{JsiiMethod: "addMinConnectionCountAlarm", GoMethod: "AddMinConnectionCountAlarm"},
			_jsii_.MemberProperty{JsiiProperty: "alarmFactory", GoGetter: "AlarmFactory"},
		},
		func() interface{} {
			return &jsiiProxy_ConnectionAlarmFactory{}
		},
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addAlarm", GoMethod: "AddAlarm"},
			_jsii_.MemberProperty{JsiiProperty: "addToSummaryDashboard", GoGetter: "AddToSummaryDashboard"},
			_jsii_.MemberProperty{JsiiProperty: "alarms", GoGetter: "Alarms"},
			_jsii_.MemberMethod{JsiiMethod: "alarmWidgets", GoMethod: "AlarmWidgets"},
			_jsii_.MemberProperty{JsiiProperty: "anomalyDetectingAlarmFactory", GoGetter: "AnomalyDetectingAlarmFactory"},
			_jsii_.MemberMethod{JsiiMethod: "createAlarmFactory", GoMethod: "CreateAlarmFactory"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addDynamicSegment", GoMethod: "AddDynamicSegment"},
			...
			_jsii_.MemberMethod{JsiiMethod: "getDashboard", GoMethod: "GetDashboard"},
			_jsii_.MemberProperty{JsiiProperty: "node", GoGetter: "Node"},
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.jsiiProxy_IDynamicDashboardFactory)
			return &j
		},
	)
	_jsii_.RegisterEnum(
		"cdk-monitoring-constructs.DefaultDashboards",
		reflect.TypeOf((*DefaultDashboards)(nil)).Elem(),
		map[string]interface{}{
			"SUMMARY": DefaultDashboards_SUMMARY,
			"DETAIL": DefaultDashboards_DETAIL,
			"ALARMS": DefaultDashboards_ALARMS,
		},
	)
	_jsii_.RegisterClass(
		"cdk-monitoring-constructs.DefaultMetricAdjuster",
		reflect.TypeOf((*DefaultMetricAdjuster)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "adjustMetric", GoMethod: "AdjustMetric"},
		},
		func() interface{} {
	...
	_jsii_.RegisterStruct(
		"cdk-monitoring-constructs.DynamicDashboardConfiguration",
		reflect.TypeOf((*DynamicDashboardConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"cdk-monitoring-constructs.DynamicDashboardFactory",
		reflect.TypeOf((*DynamicDashboardFactory)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addDynamicSegment", GoMethod: "AddDynamicSegment"},
			_jsii_.MemberMethod{JsiiMethod: "createDashboard", GoMethod: "CreateDashboard"},
			_jsii_.MemberProperty{JsiiProperty: "dashboards", GoGetter: "Dashboards"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "gsiAlarmFactory", GoGetter: "GsiAlarmFactory"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "metricMaxRedisEngineCpuUtilizationInPercent", GoMethod: "MetricMaxRedisEngineCpuUtilizationInPercent"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "createMetricFactory", GoMethod: "CreateMetricFactory"},
			_jsii_.MemberMethod{JsiiMethod: "createRedisEngineCpuUsageWidget", GoMethod: "CreateRedisEngineCpuUsageWidget"},
			_jsii_.MemberMethod{JsiiMethod: "createTitleWidget", GoMethod: "CreateTitleWidget"},
			_jsii_.MemberMethod{JsiiMethod: "createWidgetFactory", GoMethod: "CreateWidgetFactory"},
			...
			_jsii_.MemberProperty{JsiiProperty: "localAlarmNamePrefixOverride", GoGetter: "LocalAlarmNamePrefixOverride"},
			_jsii_.MemberProperty{JsiiProperty: "memoryUsageAnnotations", GoGetter: "MemoryUsageAnnotations"},
			_jsii_.MemberProperty{JsiiProperty: "redisEngineCpuUsageAnnotations", GoGetter: "RedisEngineCpuUsageAnnotations"},
			_jsii_.MemberProperty{JsiiProperty: "redisEngineCpuUsageMetric", GoGetter: "RedisEngineCpuUsageMetric"},
			_jsii_.MemberProperty{JsiiProperty: "scope", GoGetter: "Scope"},
			_jsii_.MemberMethod{JsiiMethod: "summaryWidgets", GoMethod: "SummaryWidgets"},
	...
	_jsii_.RegisterStruct(
		"cdk-monitoring-constructs.FirehoseStreamLimitThreshold",
		reflect.TypeOf((*FirehoseStreamLimitThreshold)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterStruct(
		"cdk-monitoring-constructs.HighConnectionCountThreshold",
		reflect.TypeOf((*HighConnectionCountThreshold)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterStruct(
		"cdk-monitoring-constructs.HighServerlessDatabaseCapacityThreshold",
		reflect.TypeOf((*HighServerlessDatabaseCapacityThreshold)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterInterface(
		"cdk-monitoring-constructs.IAlarmNamingStrategy",
		reflect.TypeOf((*IAlarmNamingStrategy)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "getDedupeString", GoMethod: "GetDedupeString"},
			_jsii_.MemberMethod{JsiiMethod: "getName", GoMethod: "GetName"},
			_jsii_.MemberMethod{JsiiMethod: "getWidgetLabel", GoMethod: "GetWidgetLabel"},
		...
		func() interface{} {
			return &jsiiProxy_IAlarmNamingStrategy{}
		},
	)
	_jsii_.RegisterInterface(
	...
	_jsii_.RegisterInterface(
		"cdk-monitoring-constructs.IDynamicDashboardFactory",
		reflect.TypeOf((*IDynamicDashboardFactory)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addDynamicSegment", GoMethod: "AddDynamicSegment"},
			_jsii_.MemberMethod{JsiiMethod: "getDashboard", GoMethod: "GetDashboard"},
		},
		func() interface{} {
			return &jsiiProxy_IDynamicDashboardFactory{}
		},
	)
	_jsii_.RegisterInterface(
		"cdk-monitoring-constructs.IDynamicDashboardSegment",
		reflect.TypeOf((*IDynamicDashboardSegment)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "widgetsForDashboard", GoMethod: "WidgetsForDashboard"},
		},
		func() interface{} {
			return &jsiiProxy_IDynamicDashboardSegment{}
		},
	)
	_jsii_.RegisterInterface(
	...
	_jsii_.RegisterInterface(
		"cdk-monitoring-constructs.IMetricAdjuster",
		reflect.TypeOf((*IMetricAdjuster)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "adjustMetric", GoMethod: "AdjustMetric"},
		},
		func() interface{} {
			return &jsiiProxy_IMetricAdjuster{}
		},
	)
	_jsii_.RegisterInterface(
		"cdk-monitoring-constructs.IPublisherConsumer",
		reflect.TypeOf((*IPublisherConsumer)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "consume", GoMethod: "Consume"},
		},
		func() interface{} {
			return &jsiiProxy_IPublisherConsumer{}
		},
	)
	_jsii_.RegisterInterface(
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addFirehoseStreamExceedSafetyThresholdAlarm", GoMethod: "AddFirehoseStreamExceedSafetyThresholdAlarm"},
			_jsii_.MemberMethod{JsiiMethod: "addIteratorMaxAgeAlarm", GoMethod: "AddIteratorMaxAgeAlarm"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "incomingLimitAnnotations", GoGetter: "IncomingLimitAnnotations"},
	...
	_jsii_.RegisterEnum(
		...
		map[string]interface{}{
			...
			"TM95_TOP": LatencyType_TM95_TOP,
			"TM99_TOP": LatencyType_TM99_TOP,
			"TM999_TOP": LatencyType_TM999_TOP,
			"TM9999_TOP": LatencyType_TM9999_TOP,
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "createAlarmFactory", GoMethod: "CreateAlarmFactory"},
			_jsii_.MemberMethod{JsiiMethod: "createdAlarms", GoMethod: "CreatedAlarms"},
			_jsii_.MemberMethod{JsiiMethod: "createIncomingLogsWidget", GoMethod: "CreateIncomingLogsWidget"},
			_jsii_.MemberMethod{JsiiMethod: "createMetricFactory", GoMethod: "CreateMetricFactory"},
			_jsii_.MemberMethod{JsiiMethod: "createTitleWidget", GoMethod: "CreateTitleWidget"},
			_jsii_.MemberMethod{JsiiMethod: "createWidgetFactory", GoMethod: "CreateWidgetFactory"},
			_jsii_.MemberProperty{JsiiProperty: "incomingLogEventsMetric", GoGetter: "IncomingLogEventsMetric"},
	...
	_jsii_.RegisterStruct(
		"cdk-monitoring-constructs.LowConnectionCountThreshold",
		reflect.TypeOf((*LowConnectionCountThreshold)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterStruct(
		"cdk-monitoring-constructs.MaxSecretCountThreshold",
		reflect.TypeOf((*MaxSecretCountThreshold)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
	...
	_jsii_.RegisterEnum(
		...
		map[string]interface{}{
			...
			"TM95_TOP": MetricStatistic_TM95_TOP,
			"TM99_TOP": MetricStatistic_TM99_TOP,
			"TM999_TOP": MetricStatistic_TM999_TOP,
			"TM9999_TOP": MetricStatistic_TM9999_TOP,
	...
	_jsii_.RegisterStruct(
		"cdk-monitoring-constructs.MinSecretCountThreshold",
		reflect.TypeOf((*MinSecretCountThreshold)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"cdk-monitoring-constructs.MinUsageCountThreshold",
		reflect.TypeOf((*MinUsageCountThreshold)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		func() interface{} {
			...
			_jsii_.InitJsiiProxy(&j.jsiiProxy_IDynamicDashboardSegment)
			return &j
		},
	)
	_jsii_.RegisterClass(
	...
	_jsii_.RegisterStruct(
		"cdk-monitoring-constructs.MonitoringDynamicDashboardsProps",
		reflect.TypeOf((*MonitoringDynamicDashboardsProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "monitorAuroraCluster", GoMethod: "MonitorAuroraCluster"},
			...
			_jsii_.MemberMethod{JsiiMethod: "monitorSecretsManager", GoMethod: "MonitorSecretsManager"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "addAlarmActions", GoMethod: "AddAlarmActions"},
			_jsii_.MemberMethod{JsiiMethod: "flattenedAlarmActions", GoMethod: "FlattenedAlarmActions"},
		},
		func() interface{} {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "queryDurationAnnotations", GoGetter: "QueryDurationAnnotations"},
			_jsii_.MemberProperty{JsiiProperty: "readLatencyMetric", GoGetter: "ReadLatencyMetric"},
			_jsii_.MemberProperty{JsiiProperty: "scope", GoGetter: "Scope"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*Route53HealthCheckMetricAdjuster)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "adjustMetric", GoMethod: "AdjustMetric"},
		},
		func() interface{} {
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SecretsManagerAlarmFactory)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addChangeInSecretCountAlarm", GoMethod: "AddChangeInSecretCountAlarm"},
			_jsii_.MemberMethod{JsiiMethod: "addMaxSecretCountAlarm", GoMethod: "AddMaxSecretCountAlarm"},
			_jsii_.MemberMethod{JsiiMethod: "addMinSecretCountAlarm", GoMethod: "AddMinSecretCountAlarm"},
			_jsii_.MemberProperty{JsiiProperty: "alarmFactory", GoGetter: "AlarmFactory"},
		},
		func() interface{} {
			return &jsiiProxy_SecretsManagerAlarmFactory{}
		},
	)
	_jsii_.RegisterClass(
		"cdk-monitoring-constructs.SecretsManagerMetricFactory",
		reflect.TypeOf((*SecretsManagerMetricFactory)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "metricFactory", GoGetter: "MetricFactory"},
			_jsii_.MemberMethod{JsiiMethod: "metricSecretCount", GoMethod: "MetricSecretCount"},
		},
		func() interface{} {
			return &jsiiProxy_SecretsManagerMetricFactory{}
		},
	)
	_jsii_.RegisterClass(
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SecretsManagerMonitoring)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "addAlarm", GoMethod: "AddAlarm"},
			_jsii_.MemberProperty{JsiiProperty: "alarms", GoGetter: "Alarms"},
			_jsii_.MemberMethod{JsiiMethod: "alarmWidgets", GoMethod: "AlarmWidgets"},
			...
			_jsii_.MemberMethod{JsiiMethod: "createdAlarms", GoMethod: "CreatedAlarms"},
			_jsii_.MemberMethod{JsiiMethod: "createMetricFactory", GoMethod: "CreateMetricFactory"},
			_jsii_.MemberMethod{JsiiMethod: "createSecretsCountWidget", GoMethod: "CreateSecretsCountWidget"},
			_jsii_.MemberMethod{JsiiMethod: "createTitleWidget", GoMethod: "CreateTitleWidget"},
			_jsii_.MemberMethod{JsiiMethod: "createWidgetFactory", GoMethod: "CreateWidgetFactory"},
			_jsii_.MemberProperty{JsiiProperty: "localAlarmNamePrefixOverride", GoGetter: "LocalAlarmNamePrefixOverride"},
			_jsii_.MemberProperty{JsiiProperty: "scope", GoGetter: "Scope"},
			_jsii_.MemberProperty{JsiiProperty: "secretsCountAnnotation", GoGetter: "SecretsCountAnnotation"},
			_jsii_.MemberProperty{JsiiProperty: "secretsCountMetric", GoGetter: "SecretsCountMetric"},
			_jsii_.MemberProperty{JsiiProperty: "secretsManagerAlarmFactory", GoGetter: "SecretsManagerAlarmFactory"},
			_jsii_.MemberMethod{JsiiMethod: "summaryWidgets", GoMethod: "SummaryWidgets"},
			_jsii_.MemberProperty{JsiiProperty: "title", GoGetter: "Title"},
			_jsii_.MemberMethod{JsiiMethod: "widgets", GoMethod: "Widgets"},
			_jsii_.MemberMethod{JsiiMethod: "widgetsForDashboard", GoMethod: "WidgetsForDashboard"},
	...
	_jsii_.RegisterStruct(
		"cdk-monitoring-constructs.SecretsManagerMonitoringOptions",
		reflect.TypeOf((*SecretsManagerMonitoringOptions)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"cdk-monitoring-constructs.SecretsManagerMonitoringProps",
		reflect.TypeOf((*SecretsManagerMonitoringProps)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "createAlarmFactory", GoMethod: "CreateAlarmFactory"},
			_jsii_.MemberMethod{JsiiMethod: "createdAlarms", GoMethod: "CreatedAlarms"},
			_jsii_.MemberMethod{JsiiMethod: "createDaysSinceLastChangeWidget", GoMethod: "CreateDaysSinceLastChangeWidget"},
			_jsii_.MemberMethod{JsiiMethod: "createDaysSinceLastRotationWidget", GoMethod: "CreateDaysSinceLastRotationWidget"},
			_jsii_.MemberMethod{JsiiMethod: "createMetricFactory", GoMethod: "CreateMetricFactory"},
			_jsii_.MemberMethod{JsiiMethod: "createTitleWidget", GoMethod: "CreateTitleWidget"},
			_jsii_.MemberMethod{JsiiMethod: "createWidgetFactory", GoMethod: "CreateWidgetFactory"},
			_jsii_.MemberProperty{JsiiProperty: "daysSinceLastChangeAnnotations", GoGetter: "DaysSinceLastChangeAnnotations"},
			_jsii_.MemberProperty{JsiiProperty: "daysSinceLastChangeMetric", GoGetter: "DaysSinceLastChangeMetric"},
			_jsii_.MemberProperty{JsiiProperty: "daysSinceLastRotationAnnotations", GoGetter: "DaysSinceLastRotationAnnotations"},
			_jsii_.MemberProperty{JsiiProperty: "daysSinceLastRotationMetric", GoGetter: "DaysSinceLastRotationMetric"},
			_jsii_.MemberProperty{JsiiProperty: "localAlarmNamePrefixOverride", GoGetter: "LocalAlarmNamePrefixOverride"},
			_jsii_.MemberProperty{JsiiProperty: "scope", GoGetter: "Scope"},
			_jsii_.MemberProperty{JsiiProperty: "showLastRotationWidget", GoGetter: "ShowLastRotationWidget"},
			_jsii_.MemberMethod{JsiiMethod: "summaryWidgets", GoMethod: "SummaryWidgets"},
			_jsii_.MemberProperty{JsiiProperty: "title", GoGetter: "Title"},
			_jsii_.MemberMethod{JsiiMethod: "widgets", GoMethod: "Widgets"},
			_jsii_.MemberMethod{JsiiMethod: "widgetsForDashboard", GoMethod: "WidgetsForDashboard"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			_jsii_.MemberMethod{JsiiMethod: "alarmWidgets", GoMethod: "AlarmWidgets"},
			_jsii_.MemberProperty{JsiiProperty: "dashboardsToInclude", GoGetter: "DashboardsToInclude"},
			_jsii_.MemberMethod{JsiiMethod: "summaryWidgets", GoMethod: "SummaryWidgets"},
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*StaticSegmentDynamicAdapter)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "props", GoGetter: "Props"},
			_jsii_.MemberMethod{JsiiMethod: "widgetsForDashboard", GoMethod: "WidgetsForDashboard"},
		},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "addMaxUsageCountAlarm", GoMethod: "AddMaxUsageCountAlarm"},
			_jsii_.MemberMethod{JsiiMethod: "addMemoryUsagePercentAlarm", GoMethod: "AddMemoryUsagePercentAlarm"},
			_jsii_.MemberMethod{JsiiMethod: "addMinUsageCountAlarm", GoMethod: "AddMinUsageCountAlarm"},
			_jsii_.MemberProperty{JsiiProperty: "alarmFactory", GoGetter: "AlarmFactory"},
		},
		func() interface{} {
