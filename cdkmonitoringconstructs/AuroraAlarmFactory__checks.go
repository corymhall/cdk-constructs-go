...
func (a *jsiiProxy_AuroraAlarmFactory) validateAddMaxServerlessDatabaseCapacityParameters(metric interface{}, props *HighServerlessDatabaseCapacityThreshold) error {
	if metric == nil {
...
func validateNewAuroraAlarmFactoryParameters(alarmFactory AlarmFactory) error {
	if alarmFactory == nil {
