...
export interface CfnDashboardProps {
   ...
   */
  readonly dashboardDefinition: string | cdk.IResolvable;
 ...
 * @stability external
 * @link arn:aws:cloudformation:us-east-1::type/resource/7171b96e5d207b947eb72ca9ce05247c246de623/Datadog-Dashboards-Dashboard
 */
export class CfnDashboard extends cdk.CfnResource {
  ...
  */
  ...
  protected get cfnProperties(): Record<string, any> {
    return {
      dashboardDefinition: this.props.dashboardDefinition,
    };
  }
  protected renderProperties(props: Record<string, any>): Record<string, any> {
    return {
      DashboardDefinition: props.dashboardDefinition,
    };
  }
}
